...
paste("There are this many non-NA score5 weighted averages after the count-based filtering: values",sum(!is.na(sort_combined2$sort3)))
...
```{r}
(ggplot() + geom_point(data = sort_combined2, aes(x = sort1, y = sort2), alpha = 0.05) | ggplot() + geom_point(data = sort_combined2, aes(x = sort1, y = sort3), alpha = 0.05) | ggplot() + geom_point(data = sort_combined2, aes(x = sort1, y = sort4), alpha = 0.05)) / (ggplot() + geom_point(data = sort_combined2, aes(x = sort2, y = sort3), alpha = 0.05) | 
...
complete_frame3$calibrated_score <- complete_frame3$mfi_lm_norm #L/(1+exp(-k*(log10(complete_frame3$mfi_lm_norm) - xnot))) + 0.001
