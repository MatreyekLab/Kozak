...
```{r}
(ggplot() + geom_point(data = sort_combined2, aes(x = sort1, y = sort2), alpha = 0.05) | ggplot() + geom_point(data = sort_combined2, aes(x = sort1, y = sort3), alpha = 0.05) | ggplot() + geom_point(data = sort_combined2, aes(x = sort1, y = sort4), alpha = 0.05) | ggplot() + geom_point(data = sort_combined2, aes(x = sort1, y = sort5), alpha = 0.05) | ggplot() + geom_point(data = sort_combined2, aes(x = sort2, y = sort3), alpha = 0.05)) / (ggplot() + geom_point(data = sort_combined2, aes(x = sort2, y = sort4), alpha = 0.05) | 
ggplot() + geom_point(data = sort_combined2, aes(x = sort2, y = sort5), alpha = 0.05) | 
ggplot() + geom_point(data = sort_combined2, aes(x = sort3, y = sort4), alpha = 0.05) | 
ggplot() + geom_point(data = sort_combined2, aes(x = sort3, y = sort5), alpha = 0.05) | 
ggplot() + geom_point(data = sort_combined2, aes(x = sort4, y = sort5), alpha = 0.05))
```
...
clinvar2_acmg[clinvar2_acmg$gene == "MLH1" & clinvar2_acmg$hgvs_conseq == "c.-3A>T" & clinvar2_acmg$kozak == "GCCAAAATG","comment"] <- "VUS that is likely pathogenic"
...
clinvar2_acmg[clinvar2_acmg$gene == "LMNA" & clinvar2_acmg$hgvs_conseq == "c.-5C>A" & clinvar2_acmg$kozak == "CCGGCCATG","comment"] <- "VUS that is likely pathogenic"
